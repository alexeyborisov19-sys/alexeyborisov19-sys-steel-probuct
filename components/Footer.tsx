...
const columns = [
  ["Компания", ["О компании", "Преимущества", "Сертификаты", "Статьи и экспертиза"]],
    ...
    <div className="container">
      <div className="grid gap-9 lg:grid-cols-[1.35fr_repeat(4,1fr)_1.1fr]">
        ...
        <div>
          ...
          <p className="mt-3 text-xs leading-relaxed text-white/55">г. Смоленск,<br />Рославльское шоссе,<br />7-й км, стр. 3</p>
        </div>
      </div>
      ...
      <div className="mt-5 text-[10px] text-white/35">© 2026 Сталь Продукт. Все права защищены.</div>
    </div>
  </footer>;
}
