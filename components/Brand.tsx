export function Brand() {
  return <div className="flex min-w-max items-center gap-3">
    ...
    <span className="hidden border-l border-white/20 pl-3 text-[10px] font-medium uppercase leading-[1.35] tracking-[.055em] text-white/60 sm:block">Инженерные решения<br />из листового металла</span>
  </div>;
}
