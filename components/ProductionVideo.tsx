...
export function ProductionShowreel() {
  ...
  return <>
    ...
    <section ref={sectionRef} id="production-video" className="bg-[#0c1013] py-14 sm:py-16">
      <div className="container grid gap-8 lg:grid-cols-[minmax(0,.64fr)_minmax(0,1fr)] lg:items-center">
        <div className="max-w-xl">
          ...
          <div className="mt-7 flex flex-wrap gap-3 text-xs font-bold uppercase tracking-[.12em] text-white/60">
        ...
        <div className="production-video-frame">
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 flex items-end justify-between bg-gradient-to-t from-black/80 via-black/15 to-transparent px-5 pb-5 pt-16">
            <span className="text-xs font-bold uppercase tracking-[.16em] text-white/75">Производство «Сталь Продукт»</span>
            <span className="flex items-center gap-2 text-xs font-bold uppercase tracking-[.15em] text-steel-orange"><i className="h-2 w-2 animate-pulse rounded-full bg-steel-orange" />11 секунд</span>
          </div>
        </div>
      </div>
    </section>
