  ...
  return <section className="relative isolate min-h-[610px] overflow-hidden bg-steel-black pt-[72px]">
    ...
    <div className="container relative z-10 grid min-h-[538px] items-end pb-12 pt-16 lg:grid-cols-[1fr_auto] lg:pb-14">
      <div className="max-w-3xl">
        ...
        <div className="mt-7 flex flex-wrap gap-3"><a className="clip-corner bg-steel-orange px-6 py-3 text-xs font-bold uppercase transition hover:bg-orange-600" href="/contacts#contact-form">Получить расчет&nbsp; →</a><a className="clip-corner border border-white/45 px-6 py-3 text-xs font-bold uppercase transition hover:border-steel-orange hover:text-steel-orange" href="/production#production-video">◉&nbsp; Смотреть производство</a></div>
        <p className="mt-5 text-[11px] text-white/60">♢&nbsp; Нам доверяют строительные и производственные компании по всей России · PDF-каталог и первичная консультация — без регистрации</p>
      </div>
