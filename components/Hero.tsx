  ...
  return <section className={`relative isolate overflow-hidden bg-steel-black ${spacing}`}>
    ...
    <div className="container relative z-10 grid min-h-[538px] items-end pb-12 pt-16 lg:grid-cols-[1fr_auto] lg:pb-14">
      <div className="max-w-3xl">
        ...
        <div className="mt-7 flex flex-wrap gap-3"><Link className="clip-corner bg-steel-orange px-6 py-3 text-[13px] font-bold uppercase transition hover:bg-orange-600" href="/contacts#contact-form">Получить расчёт&nbsp; →</Link><Link className="clip-corner border border-white/45 px-6 py-3 text-[13px] font-bold uppercase transition hover:border-steel-orange hover:text-steel-orange" href="/production#production-video">◉&nbsp; Смотреть производство</Link></div>
