...
export function ClientManufacturingWorkspace() {
  ...
  return (
    <div className="bg-[#090c0e] pb-24 text-white xl:pb-10">
      ...
      {project.parts.length > 0 && (
        <div className="mobile-quote-bar fixed inset-x-0 bottom-0 z-[95] flex items-center gap-3 border-t border-white/12 bg-[#101416]/95 px-4 py-3 backdrop-blur-sm xl:hidden">
