...
export function QuoteRequestForm() {
  ...
  return <form id="quote-request-form" name="quote-request-form" data-ym-form="quote-request" onSubmit={handleSubmit} onFocus={markFormStarted} className="ym-hide-content grid gap-6" noValidate>
