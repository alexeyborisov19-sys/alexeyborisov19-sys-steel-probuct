...
export function CookieConsent() {
  ...
  return <aside ref={bannerRef} className="cookie-consent-bar fixed bottom-4 left-4 right-4 z-[90] border border-white/15 bg-[#151719]/95 p-4 shadow-2xl backdrop-blur-md sm:left-auto sm:right-6 sm:w-[min(510px,calc(100vw-48px))] sm:p-5" aria-label="Настройки cookies">
    ...
    <p className="mt-2 text-xs leading-relaxed text-white/60">Сайт использует необходимые cookies для работы форм и настроек. Яндекс Метрика и Вебвизор включаются только после вашего разрешения. Вы можете продолжить без аналитики и в любой момент изменить выбор в подвале сайта. Подробнее — в <Link prefetch={false} className="text-steel-orange underline-offset-2 hover:underline" href={legalLinks.cookies}>политике cookies</Link> и <Link prefetch={false} className="text-steel-orange underline-offset-2 hover:underline" href={legalLinks.privacy}>политике обработки данных</Link>.</p>
