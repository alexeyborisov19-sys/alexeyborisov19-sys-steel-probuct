...
import { requireProductionEnabled } from "@/lib/server/production-access/page-context";
...
export default function LoginPage() {
  ...
  return <main className="grid min-h-screen place-items-center bg-[#090b0d] px-5 text-white">
    <section className="w-full max-w-md border border-white/10 bg-[#111519] p-7 shadow-2xl">
      ...
      <h1 className="mt-3 text-2xl font-semibold">Вход в производство</h1>
      ...
      <LoginForm endpoint="/api/internal/production-access/login" />
    </section>
  </main>;
}
