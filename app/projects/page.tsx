...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Проекты Сталь Продукт: фасадные, промышленные и инженерные решения из листового металла для объектов по России.",
  path: "/projects",
  image: "/images/web/project-residential.jpg",
  keywords: [
    "реализованные проекты металлоконструкции",
    "металлокассеты объекты",
    "фасадные проекты",
  ],
});
...
const supplied = [
  ["Металлокассеты", "18 500 м²"],
  ["Парапеты", "2 300 м.п."],
  ["Корзины для кондиционеров", "1 240 шт."],
  ["Кронштейны для кондиционеров", "1 240 шт."],
  ["Вентиляционные решетки", "850 шт."],
  ["Электротехнические шкафы", "160 шт."],
  ["Люки доступа", "320 шт."],
  ["Кровельные ограждения", "650 м.п."],
  ["Закладные детали", "3 800 шт."],
];
...
export default function ProjectsPage() {
  return (
    <PageLayout
      ...
      eyebrow="Проекты"
      title="Реализованные проекты"
      description="Более 500 успешно реализованных проектов для строительства, промышленности и инфраструктуры по всей России."
      image="/images/web/project-residential.jpg"
    >
      ...
      >
        <div className="container">
          <p className="text-xs text-white/40">
            Главная　›　Проекты　›　ЖК «Солнечный город»
          </p>
          <div className="mt-7 grid gap-5 xl:grid-cols-[.85fr_2fr_1.1fr]">
            <aside className="border border-white/10 bg-[#111519] p-5">
              ...
              <dl className="mt-4 space-y-3 text-xs">
                {[
                  ...
                  ["Регион", "г. Москва"],
                  ["Период реализации", "2022–2023 гг."],
                  ["Статус", "Реализован"],
                  ["Площадь", "85 000 м²"],
                ].map(([term, value]) => (
                  <div
            ...
            <div>
              <h2 className="text-3xl font-semibold">ЖК «Солнечный город»</h2>
              ...
              <div className="mt-5 grid grid-cols-4 gap-3">
                {[
                  ["52", "вида изделий"],
                  ["1200+", "изделий изготовлено"],
                  ["85 тыс. м²", "площадь фасада"],
                  ["100%", "выполнено в срок"],
                ].map(([value, label]) => (
                  <div key={label}>
            ...
            <aside className="border border-white/10 bg-[#111519] p-5">
              <h3 className="text-lg font-semibold">Поставленная продукция</h3>
