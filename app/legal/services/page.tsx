...
function getServices() {
  ...
  },
  {
    ...
    condition: "Подготовлен только архитектурный фундамент. До отдельной приёмки система выключена; первичные заявки продолжают храниться в защищённых JSON-каталогах на российском сервере.",
  },
  {
