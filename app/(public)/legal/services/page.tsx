...
export default function ServicesPage() {
  ...
  return <LegalDocument path={legalLinks.services} title="Сервисы обработки данных" description="Прозрачный перечень категорий систем, связанных с работой сайта и заявок.">
    ...
    <p>На российском VPS выполняется резервное копирование в закрытый каталог, после чего архив шифруется отдельным ключом и передаётся в закрытое объектное хранилище Beget на территории Российской Федерации. После контрольной обратной загрузки проверяются SHA-256 и возможность чтения зашифрованного архива без перезаписи рабочих данных. Ключ шифрования не передаётся в объектное хранилище. Хранение VPS и резервной копии у одного провайдера снижает защиту от отказа или компрометации всего аккаунта, поэтому Оператор дополнительно контролирует доступ, срок хранения и возможность восстановления.</p>
