...
function getServices() {
  ...
  },
  {
    ...
    data: "Автоматическая индексация и доступ сотрудников отсутствуют",
    condition: "Программные модули закрытой системы подготовлены, но до отдельной технической и организационно-правовой приёмки система выключена и сотрудникам недоступна. Первичные заявки продолжают храниться в защищённых JSON-каталогах на российском сервере.",
  },
  {
...
export default function ServicesPage() {
  ...
  return <LegalDocument path={legalLinks.services} title="Сервисы обработки данных" description="Прозрачный перечень категорий систем, связанных с работой сайта и заявок.">
    ...
    <p>Основные заявки и файлы хранятся в течение срока, необходимого для рассмотрения запроса, и удаляются по утверждённому Оператором правилу хранения. Технический журнал подтверждения согласия хранится отдельно и не содержит открытых телефона или e-mail. Существующий технический скрипт физического удаления не используется как окончательная процедура: до ввода согласованного процесса удаление требует проверки законных оснований, запретов на удаление и подтверждения ответственным сотрудником.</p>
