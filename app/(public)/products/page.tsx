      ...
      <div className="container">
        ...
        <div className="mt-9 grid gap-6 lg:grid-cols-2">
          <article className="border border-white/12 bg-[#111519] p-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/62">Ровная плоскость фасада держится не запасом металла, а точностью карты и жёсткостью её краёв. Отбортовка, рёбра и правильно назначенный радиус гиба дают кассете форму, которая не «играет» на солнце и не собирает волну по длине шва.</p>
            <p className="mt-3 text-sm leading-relaxed text-white/62">Поэтому увеличение толщины редко решает проблему видимой неровности — чаще решает пересмотр краевого узла. Лишний металл при этом добавляет массы подсистеме и стоимости всему фасаду.</p>
          </article>
          <article className="border border-white/12 bg-[#111519] p-6">
            <h3 className="text-lg font-semibold">Шов — это решение, а не зазор</h3>
            <p className="mt-3 text-sm leading-relaxed text-white/62">Ширина и ритм шва задают рисунок фасада и одновременно работают на температурное расширение. Слишком узкий шов подчёркивает любое отклонение раскладки, слишком широкий превращает плоскость в сетку.</p>
            <p className="mt-3 text-sm leading-relaxed text-white/62">Раскладку удобнее согласовывать до изготовления: тогда шов попадает в оси проёмов и этажей, а не в случайные места, и подрезка карт на объекте не требуется.</p>
          </article>
          <article className="border border-white/12 bg-[#111519] p-6">
            <h3 className="text-lg font-semibold">Кромка стареет первой</h3>
            <p className="mt-3 text-sm leading-relaxed text-white/62">Порошковое покрытие на остром ребре всегда тоньше, чем на плоскости, и повреждается раньше. Отсюда правило: кромки притупляют, а к сварным зонам подходят отдельно — там выгорает цинк и остаются брызги.</p>
            <p className="mt-3 text-sm leading-relaxed text-white/62">Это не косметика. Именно с кромок и стыков на фасаде начинается коррозия, и видно её становится через сезон-два, когда доступ к элементу уже затруднён.</p>
          </article>
          <article className="border border-white/12 bg-[#111519] p-6">
            <h3 className="text-lg font-semibold">Комплект собирается на объекте, а не на складе</h3>
            <p className="mt-3 text-sm leading-relaxed text-white/62">Кассеты, откосы, отливы, парапетные крышки и примыкания образуют один контур. Если элементы приходят разными партиями и с разной маркировкой, монтаж превращается в сортировку.</p>
            <p className="mt-3 text-sm leading-relaxed text-white/62">Поэтому состав удобнее вести по зонам объекта: маркировка, упаковка и порядок отгрузки согласуются так, чтобы на площадке открывали ровно то, что нужно этому фасаду сегодня.</p>
          </article>
        </div>
      </div>
    </section>
