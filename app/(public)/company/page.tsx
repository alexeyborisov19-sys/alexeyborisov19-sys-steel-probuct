...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Сталь Продукт — инженерно-производственная компания: 2 000+ м² производства, лазерная резка, гибка, сварка, порошковая окраска и поставка по России.",
  path: "/company",
...
const productionCapabilities = [
  ["3 лазерных комплекса с ЧПУ", "Высокоточный раскрой листового металла для серийных и индивидуальных изделий."],
  ["4 листогибочных комплекса", "Точная гибка деталей различной сложности с контролем геометрии на каждом этапе."],
  ["Панельгиб", "Производство фасадных и архитектурных элементов с заданной геометрией и повторяемым качеством."],
  ["Сварочные посты", "Сварка и сборка металлоизделий с контролем геометрии и подготовкой к следующему этапу производства."],
  ["Слесарный участок", "Доводка, подгонка, сборочные и подготовительные операции для изделий любой сложности."],
  ["3 камеры порошковой окраски", "Стабильное нанесение долговечного покрытия и возможность вести параллельную обработку изделий."],
      ...
      <div className="container relative overflow-hidden border border-white/12 bg-[#101214] p-6 sm:p-9 lg:p-12">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,.92fr)] lg:items-start">
          <div className="border-l-2 border-steel-orange pl-5 sm:pl-7">
            ...
            <h2 className="mt-4 max-w-3xl text-3xl font-semibold leading-[1.08] sm:text-4xl lg:text-5xl">Берём на себя не отдельную операцию, а результат вашего проекта</h2>
            <p className="mt-6 max-w-2xl text-sm leading-relaxed text-white/62 sm:text-base">Когда проекту нужны точность, понятный срок и готовность к монтажу, недостаточно просто заказать резку или гибку. Нужен партнёр, который понимает задачу целиком.</p>
          </div>
          ...
          <div className="relative border border-white/12 bg-[#15191c] p-6 sm:p-7">
            ...
            <p className="mt-5 text-lg font-semibold leading-snug">От первой инженерной мысли до готовой поставки.</p>
            <p className="mt-4 text-sm leading-relaxed text-white/60">«Сталь Продукт» объединяет конструкторскую подготовку, изготовление, контроль качества, упаковку и поставку. Мы превращаем идею, чертёж или техническое задание в готовое инженерное решение из листового металла.</p>
    ...
    <section className="bg-[#151719] py-12">
      <div className="container flex flex-col justify-between gap-7 border border-white/15 bg-[linear-gradient(110deg,rgba(234,91,12,.12),transparent_38%)] p-7 sm:flex-row sm:items-center sm:p-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-sm leading-relaxed text-white/62">Отправьте исходные данные. Мы оценим задачу и предложим оптимальный путь от разработки до поставки готового изделия.</p>
        </div>
