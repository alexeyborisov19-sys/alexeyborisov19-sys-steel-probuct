      ...
      <div className="container grid gap-8 xl:grid-cols-[minmax(0,1fr)_360px] xl:items-start">
        ...
        <aside className="border border-white/15 bg-[#151719] p-6 sm:p-7">
          ...
          <div className="mt-7 space-y-5 text-sm">
            ...
            {siteConfig.maxUrl ? <div className="border-l-2 border-steel-orange pl-4"><p className="text-xs uppercase tracking-[.12em] text-white/45">MAX</p><a className="mt-2 block font-semibold transition hover:text-steel-orange" href={siteConfig.maxUrl} target="_blank" rel="noopener noreferrer">Написать в MAX&nbsp; ↗</a></div> : null}
