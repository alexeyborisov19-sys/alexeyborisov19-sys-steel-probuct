...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Инженерные обзоры китайских технологий листовой обработки: подтверждённые факты, ограничения, критерии пилота и выводы для производства.",
...
export default function ChinaTechPage() {
  ...
  return (
    <PageLayout
      ...
      title="Технологии металлообработки Китая"
      description="Отбираем инженерные решения, проверяем их по первичным источникам, отделяем заявления производителей от подтверждённых фактов и объясняем, как оценить технологию на своей номенклатуре."
          ...
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1.15fr)_minmax(360px,.85fr)] xl:items-end">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-base leading-8 text-white/64">
                Мы не копируем отраслевые публикации. Новость используем как сигнал, затем
                ищем документацию производителя, фиксируем ограничения и формируем программу
                проверки на собственной номенклатуре. Если факта нельзя подтвердить, он остаётся
                заявлением источника, а не выводом редакции.
              </p>
            </div>
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-sm leading-7 text-white/58">
              Публикации этих площадок служат началом исследования, но не считаются доказательством
              сами по себе. Технические заявления дополнительно сверяются с документацией
              производителя, спецификациями и результатами испытаний, если они доступны.
            </p>
          </div>
