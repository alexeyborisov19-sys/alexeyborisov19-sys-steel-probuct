  ...
  return (
    <>
      ...
      <PageLayout
        ...
        description="Загрузите DXF или STEP, проверьте распознанную геометрию, задайте материал, количество и производственные операции — затем получите предварительную стоимость проекта."
