...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Количество гибов и их радиусы определяются по модели автоматически. Размер развёртки гнутой детали подтверждает технолог, поскольку он зависит от инструмента и режимов конкретного оборудования.",
  },
] as const;
