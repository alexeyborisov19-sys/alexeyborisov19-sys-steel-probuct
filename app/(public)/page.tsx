...
export const metadata: Metadata = createPageMetadata({
  title: "Производство изделий из листового металла по чертежам",
  description:
...
const homeFaq = [
  { question: "Что выпускается под брендом «Сталь Продукт»?", answer: "Под брендом «Сталь Продукт» выпускаются фасадные элементы, металлокассеты, корпуса, шкафы, кожухи, рамы, кронштейны и нестандартные изделия из листового металла для строительства и промышленности." },
...
export default function Home() {
  return (
    <>
      <JsonLd
        data={[webPageSchema({
          name: "Производство изделий из листового металла по чертежам — Сталь Продукт",
          description:
