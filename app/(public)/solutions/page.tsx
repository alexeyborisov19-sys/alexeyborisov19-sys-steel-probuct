        ...
        <div className="container">
          ...
          <div className="mt-9 grid gap-6 lg:grid-cols-2">
            <article className="border border-white/12 bg-[#111519] p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed text-white/62">Начинаем с того, что изделие должно делать. Какая нагрузка, какая среда, с чем сопрягается, как обслуживается. Ответы задают материал, толщину, тип соединений и покрытие — и сразу отсекают половину вариантов.</p>
              <p className="mt-3 text-sm leading-relaxed text-white/62">На входе — документация, модель, эскиз или сам образец. Недостающее уточняем до запуска. Неоднозначный размер, всплывший внутри партии, стоит дороже любого вопроса заранее.</p>
            </article>
            <article className="border border-white/12 bg-[#111519] p-6">
              <h3 className="text-lg font-semibold">Проверка технологичности</h3>
              <p className="mt-3 text-sm leading-relaxed text-white/62">Конструкция, безупречная на экране, не всегда изготовима без потерь. Смотрим развёртки и радиусы, доступ инструмента, порядок сборки, расстояния до края у крепежа, поведение детали после сварки.</p>
              <p className="mt-3 text-sm leading-relaxed text-white/62">Половина замечаний снимается одной заменой: радиус побольше, другой крепёж, отбортовка вместо шва. Функция та же. Цена и повторяемость — другие.</p>
            </article>
            <article className="border border-white/12 bg-[#111519] p-6">
              <h3 className="text-lg font-semibold">Опытный образец до серии</h3>
              <p className="mt-3 text-sm leading-relaxed text-white/62">Образец показывает то, чего нет в документации: пружинение после гибки, реальную геометрию сварного узла, покрытие на кромках, собираемость с ответными деталями.</p>
              <p className="mt-3 text-sm leading-relaxed text-white/62">По его результатам правим конструкцию и порядок операций, фиксируем версию документации. И только потом запускаем партию — чтобы пятидесятая единица была как первая.</p>
            </article>
            <article className="border border-white/12 bg-[#111519] p-6">
              <h3 className="text-lg font-semibold">Изготовление, контроль и отгрузка</h3>
              <p className="mt-3 text-sm leading-relaxed text-white/62">Маршрут планируем целиком: раскрой, гибка, сварка и сборка, подготовка поверхности, покрытие. Порядок важен не меньше качества: часть элементов ставят до окраски, часть после. Это фиксируется в технологии.</p>
              <p className="mt-3 text-sm leading-relaxed text-white/62">Перед отгрузкой проверяем то, что работает: диагонали, плоскостность посадочных поверхностей, собираемость, покрытие. Упаковку и маркировку — под перевозку и приёмку на объекте.</p>
            </article>
          </div>
        </div>
      </section>
