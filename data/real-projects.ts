...
export const realProjects: RealProject[] = [
  ...
  },
  {
    ...
    imageAlt: "Образовательный объект — Многопрофильный лицей в микрорайоне «Соловьиная роща»",
    supply: ["металлические изделия по проекту"],
    description: "Образовательная инфраструктура крупного микрорайона — отдельное направление поставок в рамках работы с объектами «Соловьиной рощи». До размещения устойчивой локальной фотографии объекта используется нейтральная иллюстрация образовательной категории.",
  ...
  },
  {
    ...
    description: "Поставка фасадных металлокассет для проекта капитального ремонта учебного корпуса. Для карточки пока используется нейтральная отраслевая иллюстрация: достоверное современное фото фасада после ремонта в открытых источниках не подтверждено.",
