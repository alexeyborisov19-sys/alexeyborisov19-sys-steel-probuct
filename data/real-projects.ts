...
export const realProjects: RealProject[] = [
  ...
  },
  {
    ...
    image: "https://static.tildacdn.com/tild6434-6265-4335-a661-393165383762/image.png",
    imageAlt: "Многопрофильный лицей в микрорайоне «Соловьиная роща» в Смоленске",
    imageCredit: "Фото: АО СЗ «Ваш дом»",
