...
export const realProjects: RealProject[] = [
  ...
  },
  {
    ...
    image: "https://smolgazeta.ru/fc-web/fc-files/2026/01/166012.jpg",
    imageAlt: "Смоленская областная клиническая больница — работы на территории медицинского комплекса в январе 2026 года",
    imageCredit: "Фото: «Смоленская газета», пресс-материалы губернатора Смоленской области",
  ...
  },
  {
    ...
    imageAlt: "Главный вход Многопрофильного лицея в микрорайоне «Соловьиная роща»",
  ...
  },
  {
    ...
    category: "education",
    categoryLabel: "Образование",
    image: "https://smoldaily.ru/wp-content/uploads/2026/07/img_2508.jpg",
    imageAlt: "Строительство техношколы «Феникс» в Печерске летом 2026 года",
    imageCredit: "Фото: SmolDaily, пресс-материалы объекта",
