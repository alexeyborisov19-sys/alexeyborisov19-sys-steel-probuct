...
/**
 * Project-level factual calculation. It reuses the same DFM gate as the current
 * DXF workspace, but delegates cost arithmetic exclusively to the factual
 * engine. Partial positions contribute only their confirmed cost articles;
 * their missing articles remain explicit and keep the project incomplete.
 */
