...
test("the projects hub states its work boundary alongside real project claims", async () => {
  // The projects hub is now a portfolio of confirmed supplies rather than a
  // generic production-capability page. The important reader-facing limits are
  // therefore the work boundary and the fact that assembly/system performance
  // remains defined by project documentation.
  ...
  assert.match(projects, /подтверждённой информации компании/);
